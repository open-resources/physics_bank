...
myst:
  substitutions:
    ...
    params_part1_ans1_value: The tension points up, and Lorenzo moves down, so negative
      work is done.
    ...
    params_part1_ans3_value: The tension point up, and Lorenzo moves up, so positive
      work is done.
    params_part1_ans4_value: The tension points up, and Lorenzo moves down, so positive
      work is done.
---
# {{ params_vars_title }}
