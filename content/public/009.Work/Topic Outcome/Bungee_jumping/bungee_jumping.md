...
myst:
  substitutions:
    ...
    params_part1_ans1_value: The tension points up, and Aliyah moves down, so negative
      work is done.
    params_part1_ans2_value: The tension point up, and Aliyah moves up, so positive
      work is done.
    params_part1_ans3_value: The tension points up, and Aliyah moves down, so positive
      work is done.
