...
myst:
  substitutions:
    ...
    params_part1_ans3_value: The tension points up, and Savannah moves down, so negative
      work is done.
    params_part1_ans4_value: The tension points up, and Savannah moves down, so positive
      work is done.
---
# {{ params_vars_title }}
