...
myst:
  substitutions:
    ...
    params_part1_ans1_value: The tension point up, and Abbas moves up, so positive
      work is done.
    params_part1_ans2_value: The tension points up, and Abbas moves down, so negative
      work is done.
    params_part1_ans3_value: The tension points up, and Abbas moves down, so positive
      work is done.
    params_part1_ans4_value: The tension points down, and Abbas moves down, so negative
      work is done.
---
# {{ params_vars_title }}
