...
myst:
  substitutions:
    ...
    params_part1_ans2_value: The tension points down, and Ximena moves down, so negative
      work is done.
    params_part1_ans3_value: The tension point up, and Ximena moves up, so positive
      work is done.
    params_part1_ans4_value: The tension points up, and Ximena moves down, so negative
      work is done.
---
# {{ params_vars_title }}
