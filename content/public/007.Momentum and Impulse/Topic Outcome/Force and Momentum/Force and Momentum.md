...
myst:
  substitutions:
    ...
    params_part1_ans2_value: (11.0$\hat\imath$ - 21.0$\hat\jmath$)
    params_part1_ans3_value: (-11.0$\hat\imath$ + 21.0$\hat\jmath$)
    params_part1_ans4_value: (11.0$\hat\imath$ + 21.0$\hat\jmath$)
    params_part1_ans5_value: (-11.0$\hat\imath$ - 21.0$\hat\jmath$)
    params_part1_ans6_value: (-22.0$\hat\imath$ - 21.0$\hat\jmath$)
---
# {{ params_vars_title }}
