...
myst:
  substitutions:
    ...
    params_part1_ans2_value: (-2110.0$\hat\imath$ - 117.0$\hat\jmath$)
    params_part1_ans3_value: (2110.0$\hat\imath$ + 117.0$\hat\jmath$)
    params_part1_ans4_value: (-2110.0$\hat\imath$ + 117.0$\hat\jmath$)
    params_part1_ans5_value: (2110.0$\hat\imath$ - 117.0$\hat\jmath$)
    params_part1_ans6_value: (4220.0$\hat\imath$ - 117.0$\hat\jmath$)
---
# {{ params_vars_title }}
