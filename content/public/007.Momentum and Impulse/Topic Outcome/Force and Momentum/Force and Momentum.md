...
myst:
  substitutions:
    ...
    params_vars_units: N
    params_p_i: 5t^2 - 2t
    params_p_j: -4t^3 - 6t^2
    params_time: 15.8
    params_part1_ans1_value: 0
    params_part1_ans2_value: (156.0$\hat\imath$ - 3190.0$\hat\jmath$)
    params_part1_ans3_value: (-156.0$\hat\imath$ + 3190.0$\hat\jmath$)
    params_part1_ans4_value: (156.0$\hat\imath$ + 3190.0$\hat\jmath$)
    params_part1_ans5_value: (-156.0$\hat\imath$ - 3190.0$\hat\jmath$)
    params_part1_ans6_value: (-312.0$\hat\imath$ - 3190.0$\hat\jmath$)
---
# {{ params_vars_title }}
