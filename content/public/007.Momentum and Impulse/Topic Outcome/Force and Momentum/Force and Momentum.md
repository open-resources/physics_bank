...
myst:
  substitutions:
    ...
    params_vars_units: N
    params_p_i: t^3 - 2t^2 + 2t
    params_p_j: -t^2
    params_time: 16.0
    params_part1_ans1_value: 0
    params_part1_ans2_value: (706.0$\hat\imath$ - 32.0$\hat\jmath$)
    params_part1_ans3_value: (-706.0$\hat\imath$ + 32.0$\hat\jmath$)
    params_part1_ans4_value: (706.0$\hat\imath$ + 32.0$\hat\jmath$)
    params_part1_ans5_value: (-706.0$\hat\imath$ - 32.0$\hat\jmath$)
    params_part1_ans6_value: (-1412.0$\hat\imath$ - 32.0$\hat\jmath$)
---
# {{ params_vars_title }}
