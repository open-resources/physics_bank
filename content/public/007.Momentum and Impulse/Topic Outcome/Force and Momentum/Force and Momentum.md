...
myst:
  substitutions:
    ...
    params_vars_units: N
    params_p_i: -8t
    params_p_j: 5t^3 - 6t^2 + 4t
    params_time: 16.1
    params_part1_ans1_value: 0
    params_part1_ans2_value: (-8.0$\hat\imath$ + 3700.0$\hat\jmath$)
    params_part1_ans3_value: (8.0$\hat\imath$ - 3700.0$\hat\jmath$)
    params_part1_ans4_value: (-8.0$\hat\imath$ - 3700.0$\hat\jmath$)
    params_part1_ans5_value: (8.0$\hat\imath$ + 3700.0$\hat\jmath$)
    params_part1_ans6_value: (16.0$\hat\imath$ + 3700.0$\hat\jmath$)
---
# {{ params_vars_title }}
