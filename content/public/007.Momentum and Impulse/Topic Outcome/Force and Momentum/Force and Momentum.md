...
myst:
  substitutions:
    ...
    params_part1_ans2_value: (130.0$\hat\imath$ - 60.4$\hat\jmath$)
    params_part1_ans3_value: (-130.0$\hat\imath$ + 60.4$\hat\jmath$)
    params_part1_ans4_value: (130.0$\hat\imath$ + 60.4$\hat\jmath$)
    params_part1_ans5_value: (-130.0$\hat\imath$ - 60.4$\hat\jmath$)
    params_part1_ans6_value: (-260.0$\hat\imath$ - 60.4$\hat\jmath$)
---
# {{ params_vars_title }}
