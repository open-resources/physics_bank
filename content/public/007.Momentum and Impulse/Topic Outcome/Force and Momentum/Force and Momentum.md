...
myst:
  substitutions:
    ...
    params_vars_units: N
    params_p_i: 7t^2 + 5t
    params_p_j: -7t^3 + t^2 - t
    params_time: 7.04
    params_part1_ans1_value: 0
    params_part1_ans2_value: (104.0$\hat\imath$ - 1030.0$\hat\jmath$)
    params_part1_ans3_value: (-104.0$\hat\imath$ + 1030.0$\hat\jmath$)
    params_part1_ans4_value: (104.0$\hat\imath$ + 1030.0$\hat\jmath$)
    params_part1_ans5_value: (-104.0$\hat\imath$ - 1030.0$\hat\jmath$)
    params_part1_ans6_value: (-208.0$\hat\imath$ - 1030.0$\hat\jmath$)
---
# {{ params_vars_title }}
