...
myst:
  substitutions:
    ...
    params_vars_units: N
    params_p_i: 9t^2 + 9t
    params_p_j: 8t^3 + 8t^2 + 6t
    params_time: 8.93
    params_part1_ans1_value: 0
    params_part1_ans2_value: (170.0$\hat\imath$ + 2060.0$\hat\jmath$)
    params_part1_ans3_value: (-170.0$\hat\imath$ - 2060.0$\hat\jmath$)
    params_part1_ans4_value: (170.0$\hat\imath$ - 2060.0$\hat\jmath$)
    params_part1_ans5_value: (-170.0$\hat\imath$ + 2060.0$\hat\jmath$)
    params_part1_ans6_value: (-340.0$\hat\imath$ + 2060.0$\hat\jmath$)
---
# {{ params_vars_title }}
