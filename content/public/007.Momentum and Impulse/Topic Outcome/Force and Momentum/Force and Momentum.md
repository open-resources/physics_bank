...
myst:
  substitutions:
    ...
    params_vars_units: N
    params_p_i: 2t^2 - 7t
    params_p_j: -t^3 + 4t^2 - t
    params_time: 12.1
    params_part1_ans1_value: 0
    params_part1_ans2_value: (41.4$\hat\imath$ - 343.0$\hat\jmath$)
    params_part1_ans3_value: (-41.4$\hat\imath$ + 343.0$\hat\jmath$)
    params_part1_ans4_value: (41.4$\hat\imath$ + 343.0$\hat\jmath$)
    params_part1_ans5_value: (-41.4$\hat\imath$ - 343.0$\hat\jmath$)
    params_part1_ans6_value: (-82.8$\hat\imath$ - 343.0$\hat\jmath$)
---
# {{ params_vars_title }}
