...
myst:
  substitutions:
    ...
    params_vars_units: N
    params_p_i: -4t^2 - t
    params_p_j: -7t^3 - 6t^2 + t
    params_time: 4.0
    params_part1_ans1_value: 0
    params_part1_ans2_value: (-33.0$\hat\imath$ - 383.0$\hat\jmath$)
    params_part1_ans3_value: (33.0$\hat\imath$ + 383.0$\hat\jmath$)
    params_part1_ans4_value: (-33.0$\hat\imath$ + 383.0$\hat\jmath$)
    params_part1_ans5_value: (33.0$\hat\imath$ - 383.0$\hat\jmath$)
    params_part1_ans6_value: (66.0$\hat\imath$ - 383.0$\hat\jmath$)
---
# {{ params_vars_title }}
