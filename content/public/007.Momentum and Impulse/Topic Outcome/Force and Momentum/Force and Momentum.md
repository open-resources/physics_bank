...
myst:
  substitutions:
    ...
    params_part1_ans2_value: (212.0$\hat\imath$ + 17.4$\hat\jmath$)
    params_part1_ans3_value: (-212.0$\hat\imath$ - 17.4$\hat\jmath$)
    params_part1_ans4_value: (212.0$\hat\imath$ - 17.4$\hat\jmath$)
    params_part1_ans5_value: (-212.0$\hat\imath$ + 17.4$\hat\jmath$)
    params_part1_ans6_value: (-424.0$\hat\imath$ + 17.4$\hat\jmath$)
---
# {{ params_vars_title }}
