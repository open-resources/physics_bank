...
myst:
  substitutions:
    ...
    params_part1_ans2_value: (223.0$\hat\imath$ - 41.2$\hat\jmath$)
    params_part1_ans3_value: (-223.0$\hat\imath$ + 41.2$\hat\jmath$)
    params_part1_ans4_value: (223.0$\hat\imath$ + 41.2$\hat\jmath$)
    params_part1_ans5_value: (-223.0$\hat\imath$ - 41.2$\hat\jmath$)
    params_part1_ans6_value: (-446.0$\hat\imath$ - 41.2$\hat\jmath$)
---
# {{ params_vars_title }}
