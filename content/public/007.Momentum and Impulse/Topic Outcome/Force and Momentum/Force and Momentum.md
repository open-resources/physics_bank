...
myst:
  substitutions:
    ...
    params_part1_ans2_value: (-222.0$\hat\imath$ + 200.0$\hat\jmath$)
    params_part1_ans3_value: (222.0$\hat\imath$ - 200.0$\hat\jmath$)
    params_part1_ans4_value: (-222.0$\hat\imath$ - 200.0$\hat\jmath$)
    params_part1_ans5_value: (222.0$\hat\imath$ + 200.0$\hat\jmath$)
    params_part1_ans6_value: (444.0$\hat\imath$ + 200.0$\hat\jmath$)
---
# {{ params_vars_title }}
