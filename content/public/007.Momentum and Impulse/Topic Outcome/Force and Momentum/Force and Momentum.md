...
myst:
  substitutions:
    ...
    params_vars_units: N
    params_p_i: -4t^2 + 9t
    params_p_j: -t^3 - 8t^2 + t
    params_time: 19.9
    params_part1_ans1_value: 0
    params_part1_ans2_value: (-150.0$\hat\imath$ - 1510.0$\hat\jmath$)
    params_part1_ans3_value: (150.0$\hat\imath$ + 1510.0$\hat\jmath$)
    params_part1_ans4_value: (-150.0$\hat\imath$ + 1510.0$\hat\jmath$)
    params_part1_ans5_value: (150.0$\hat\imath$ - 1510.0$\hat\jmath$)
    params_part1_ans6_value: (300.0$\hat\imath$ - 1510.0$\hat\jmath$)
---
# {{ params_vars_title }}
