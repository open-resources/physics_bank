...
myst:
  substitutions:
    ...
    params_part1_ans2_value: (139.0$\hat\imath$ + 145.0$\hat\jmath$)
    params_part1_ans3_value: (-139.0$\hat\imath$ - 145.0$\hat\jmath$)
    params_part1_ans4_value: (139.0$\hat\imath$ - 145.0$\hat\jmath$)
    params_part1_ans5_value: (-139.0$\hat\imath$ + 145.0$\hat\jmath$)
    params_part1_ans6_value: (-278.0$\hat\imath$ + 145.0$\hat\jmath$)
---
# {{ params_vars_title }}
