...
myst:
  substitutions:
    ...
    params_part1_ans2_value: (91.6$\hat\imath$ - 263.0$\hat\jmath$)
    params_part1_ans3_value: (-91.6$\hat\imath$ + 263.0$\hat\jmath$)
    params_part1_ans4_value: (91.6$\hat\imath$ + 263.0$\hat\jmath$)
    params_part1_ans5_value: (-91.6$\hat\imath$ - 263.0$\hat\jmath$)
    params_part1_ans6_value: (-183.2$\hat\imath$ - 263.0$\hat\jmath$)
---
# {{ params_vars_title }}
