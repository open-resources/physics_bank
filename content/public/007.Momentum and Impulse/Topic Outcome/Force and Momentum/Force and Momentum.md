...
myst:
  substitutions:
    ...
    params_vars_units: N
    params_p_i: -6t^2 - 2t
    params_p_j: 3t^3 + 3t^2 + t
    params_time: 6.04
    params_part1_ans1_value: 0
    params_part1_ans2_value: (-74.5$\hat\imath$ + 366.0$\hat\jmath$)
    params_part1_ans3_value: (74.5$\hat\imath$ - 366.0$\hat\jmath$)
    params_part1_ans4_value: (-74.5$\hat\imath$ - 366.0$\hat\jmath$)
    params_part1_ans5_value: (74.5$\hat\imath$ + 366.0$\hat\jmath$)
    params_part1_ans6_value: (149.0$\hat\imath$ + 366.0$\hat\jmath$)
---
# {{ params_vars_title }}
