...
myst:
  substitutions:
    ...
    params_part1_ans2_value: (150.0$\hat\imath$ + 195.0$\hat\jmath$)
    params_part1_ans3_value: (-150.0$\hat\imath$ - 195.0$\hat\jmath$)
    params_part1_ans4_value: (150.0$\hat\imath$ - 195.0$\hat\jmath$)
    params_part1_ans5_value: (-150.0$\hat\imath$ + 195.0$\hat\jmath$)
    params_part1_ans6_value: (-300.0$\hat\imath$ + 195.0$\hat\jmath$)
---
# {{ params_vars_title }}
