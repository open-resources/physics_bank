...
myst:
  substitutions:
    ...
    params_part1_ans2_value: (-243.0$\hat\imath$ - 163.0$\hat\jmath$)
    params_part1_ans3_value: (243.0$\hat\imath$ + 163.0$\hat\jmath$)
    params_part1_ans4_value: (-243.0$\hat\imath$ + 163.0$\hat\jmath$)
    params_part1_ans5_value: (243.0$\hat\imath$ - 163.0$\hat\jmath$)
    params_part1_ans6_value: (486.0$\hat\imath$ - 163.0$\hat\jmath$)
---
# {{ params_vars_title }}
