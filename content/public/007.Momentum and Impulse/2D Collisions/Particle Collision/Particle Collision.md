...
myst:
  substitutions:
    ...
    params_v1: 12
    params_v2: 10
    params_part1_ans1_value: 84 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 90 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans1_feedback: Great! You got it.
    params_part1_ans2_value: 90 $kg$ $\dfrac{m}{s}\hat{\imath}$
    params_part1_ans2_feedback: Hmm... Try again.
    params_part1_ans3_value: 90 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans3_feedback: Careful! Both components are asked for.
    params_part1_ans4_value: 90 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 84 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans4_feedback: Hmm... Try again.
    params_part1_ans5_value: 84 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans5_feedback: Hmm... Try again.
    params_part1_ans6_value: 84 $kg$ $\dfrac{m}{s}\hat{\imath}$
