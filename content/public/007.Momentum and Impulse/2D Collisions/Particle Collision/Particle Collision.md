...
myst:
  substitutions:
    ...
    params_v1: 1
    params_v2: 8
    params_part1_ans1_value: 5 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 24 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    ...
    params_part1_ans4_value: 24 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 5 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    ...
    params_part1_ans6_value: 5 $kg$ $\dfrac{m}{s}\hat{\imath}$
