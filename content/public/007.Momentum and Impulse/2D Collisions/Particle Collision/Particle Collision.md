...
myst:
  substitutions:
    ...
    params_v1: 3
    params_v2: 7
    params_part1_ans1_value: 24 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 14 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    ...
    params_part1_ans4_value: 14 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 24 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans4_feedback: Hmm... Try again.
    params_part1_ans5_value: 24 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans5_feedback: Hmm... Try again.
    params_part1_ans6_value: 24 $kg$ $\dfrac{m}{s}\hat{\imath}$
