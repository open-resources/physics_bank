...
myst:
  substitutions:
    ...
    params_v1: 5
    params_v2: 10
    params_part1_ans1_value: 50 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans1_feedback: Great! You got it.
    params_part1_ans2_value: 50 $kg$ $\dfrac{m}{s}\hat{\imath}$
    params_part1_ans2_feedback: Hmm... Try again.
    params_part1_ans3_value: 50 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 10 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    ...
    params_part1_ans6_value: 10 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 50 $kg$ $\dfrac{m}{s}\hat{\jmath}$
