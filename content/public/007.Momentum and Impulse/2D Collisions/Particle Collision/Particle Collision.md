...
myst:
  substitutions:
    ...
    params_part1_ans3_value: 3 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans3_feedback: Close! Double check the directions of the unit vectors.
    params_part1_ans4_value: 3 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 16 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    ...
    params_part1_ans6_value: 16 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 3 $kg$ $\dfrac{m}{s}\hat{\jmath}$
