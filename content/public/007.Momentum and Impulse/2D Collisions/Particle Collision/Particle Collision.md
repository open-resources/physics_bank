...
myst:
  substitutions:
    ...
    params_v1: 11
    params_v2: 12
    params_part1_ans1_value: 66 $kg$ $\dfrac{m}{s}\hat{\imath}$
    ...
    params_part1_ans3_value: 60 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans3_feedback: Close! Double check the directions of the unit vectors.
    params_part1_ans4_value: 60 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 66 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans4_feedback: Hmm... Try again.
    params_part1_ans5_value: 66 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans5_feedback: Hmm... Try again.
    params_part1_ans6_value: 66 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 60 $kg$ $\dfrac{m}{s}\hat{\jmath}$
