...
myst:
  substitutions:
    ...
    params_v1: 10
    params_v2: 9
    params_part1_ans1_value: 80 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 36 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    ...
    params_part1_ans4_value: 36 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 80 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans4_feedback: Hmm... Try again.
    params_part1_ans5_value: 80 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans5_feedback: Hmm... Try again.
    params_part1_ans6_value: 80 $kg$ $\dfrac{m}{s}\hat{\imath}$
