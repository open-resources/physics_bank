...
myst:
  substitutions:
    ...
    params_v1: 9
    params_v2: 10
    params_part1_ans1_value: 9 $kg$ $\dfrac{m}{s}\hat{\imath}$
    ...
    params_part1_ans4_value: 60 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 9 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    ...
    params_part1_ans6_value: 9 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 60 $kg$ $\dfrac{m}{s}\hat{\jmath}$
