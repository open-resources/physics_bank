...
myst:
  substitutions:
    ...
    params_v1: 11
    params_v2: 15
    params_part1_ans1_value: 11 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 30 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    ...
    params_part1_ans4_value: 30 $kg$ $\dfrac{m}{s}\hat{\imath}$ + 11 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans4_feedback: Hmm... Try again.
    params_part1_ans5_value: 11 $kg$ $\dfrac{m}{s}\hat{\jmath}$
    params_part1_ans5_feedback: Hmm... Try again.
    params_part1_ans6_value: 11 $kg$ $\dfrac{m}{s}\hat{\imath}$
