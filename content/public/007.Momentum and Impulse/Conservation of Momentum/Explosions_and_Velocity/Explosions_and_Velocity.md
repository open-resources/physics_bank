...
myst:
  substitutions:
    ...
    params_part1_ans3_value: No, because the velocity should be $v$ = 43 $\rm{m/s}$
    params_part1_ans4_value: No, because the velocity should be $v$ = 4.8 $\rm{m/s/kg}$
---
# {{ params_vars_title }}
