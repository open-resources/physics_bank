...
myst:
  substitutions:
    ...
    params_part1_ans3_value: No, because the velocity should be $v$ = 49 $\rm{m/s}$
    params_part1_ans4_value: No, because the velocity should be $v$ = 8.2 $\rm{m/s/kg}$
---
# {{ params_vars_title }}
