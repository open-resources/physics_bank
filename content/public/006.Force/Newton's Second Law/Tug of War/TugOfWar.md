...
myst:
  substitutions:
    ...
    params_adultWeight: 204
    params_adultForce: 724
    params_childWeights: ' $62\ \rm{lb}$, $55\ \rm{lb}$, $64\ \rm{lb}$, $57\ \rm{lb}$'
    params_childForces: ' $116\ \rm{N}$, $104\ \rm{N}$, $100\ \rm{N}$, $98\ \rm{N}$'
---
# {{ params_vars_title }}
