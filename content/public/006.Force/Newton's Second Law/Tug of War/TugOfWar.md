...
myst:
  substitutions:
    ...
    params_adultWeight: 200
    params_adultForce: 741
    params_childWeights: ' $55\ \rm{lb}$, $70\ \rm{lb}$, $69\ \rm{lb}$, $70\ \rm{lb}$'
    params_childForces: ' $119\ \rm{N}$, $147\ \rm{N}$, $145\ \rm{N}$, $146\ \rm{N}$'
---
# {{ params_vars_title }}
