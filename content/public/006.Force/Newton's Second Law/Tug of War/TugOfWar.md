...
myst:
  substitutions:
    ...
    params_adultWeight: 203
    params_adultForce: 528
    params_childWeights: ' $67\ \rm{lb}$, $56\ \rm{lb}$, $52\ \rm{lb}$, $55\ \rm{lb}$,
      $56\ \rm{lb}$, $57\ \rm{lb}$'
    params_childForces: ' $124\ \rm{N}$, $112\ \rm{N}$, $112\ \rm{N}$, $118\ \rm{N}$,
      $97\ \rm{N}$, $99\ \rm{N}$'
---
# {{ params_vars_title }}
