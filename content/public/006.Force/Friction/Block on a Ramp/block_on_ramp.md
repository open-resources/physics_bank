...
myst:
  substitutions:
    ...
    params_theta: 20
    params_mu: 0.6
    params_part1_ans1_value: 50.0 $N$, up the incline
    params_part1_ans2_value: 140.0 $N$, up the incline
    params_part1_ans3_value: 30.0 $N$, down the incline
    params_part1_ans4_value: 83.0 $N$, down the incline
    params_part1_ans5_value: 50.0 $N$, down the incline
---
# {{ params_vars_title }}
