...
myst:
  substitutions:
    ...
    params_theta: 16
    params_mu: 0.7
    params_part1_ans1_value: 19.0 $N$, up the incline
    params_part1_ans2_value: 66.0 $N$, up the incline
    params_part1_ans3_value: 13.0 $N$, down the incline
    params_part1_ans4_value: 46.0 $N$, down the incline
    params_part1_ans5_value: 19.0 $N$, down the incline
---
# {{ params_vars_title }}
