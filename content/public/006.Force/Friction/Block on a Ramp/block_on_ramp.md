...
myst:
  substitutions:
    ...
    params_theta: 15
    params_mu: 0.2
    params_part1_ans1_value: 13.0 $N$, up the incline
    params_part1_ans2_value: 47.0 $N$, up the incline
    params_part1_ans3_value: 2.5 $N$, down the incline
    params_part1_ans4_value: 9.5 $N$, down the incline
    params_part1_ans5_value: 13.0 $N$, down the incline
---
# {{ params_vars_title }}
