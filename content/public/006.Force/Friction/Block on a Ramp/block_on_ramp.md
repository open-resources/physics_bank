...
myst:
  substitutions:
    ...
    params_theta: 31
    params_mu: 0.4
    params_part1_ans1_value: 71.0 $N$, up the incline
    params_part1_ans2_value: 120.0 $N$, up the incline
    params_part1_ans3_value: 28.0 $N$, down the incline
    params_part1_ans4_value: 47.0 $N$, down the incline
    params_part1_ans5_value: 71.0 $N$, down the incline
---
# {{ params_vars_title }}
