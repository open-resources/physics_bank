...
myst:
  substitutions:
    ...
    params_theta: 24
    params_mu: 0.1
    params_part1_ans1_value: 200.0 $N$, up the incline
    params_part1_ans2_value: 440.0 $N$, up the incline
    params_part1_ans3_value: 20.0 $N$, down the incline
    params_part1_ans4_value: 44.0 $N$, down the incline
    params_part1_ans5_value: 200.0 $N$, down the incline
---
# {{ params_vars_title }}
