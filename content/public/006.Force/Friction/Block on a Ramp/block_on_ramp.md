...
myst:
  substitutions:
    ...
    params_theta: 25
    params_mu: 0.3
    params_part1_ans1_value: 83.0 $N$, up the incline
    params_part1_ans2_value: 180.0 $N$, up the incline
    params_part1_ans3_value: 25.0 $N$, down the incline
    params_part1_ans4_value: 53.0 $N$, down the incline
    params_part1_ans5_value: 83.0 $N$, down the incline
---
# {{ params_vars_title }}
