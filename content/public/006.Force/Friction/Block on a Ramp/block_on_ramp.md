...
myst:
  substitutions:
    ...
    params_theta: 19
    params_mu: 0.3
    params_part1_ans1_value: 38.0 $N$, up the incline
    params_part1_ans2_value: 110.0 $N$, up the incline
    params_part1_ans3_value: 11.0 $N$, down the incline
    params_part1_ans4_value: 33.0 $N$, down the incline
    params_part1_ans5_value: 38.0 $N$, down the incline
---
# {{ params_vars_title }}
