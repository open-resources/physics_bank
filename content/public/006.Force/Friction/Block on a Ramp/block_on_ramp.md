...
myst:
  substitutions:
    ...
    params_theta: 35
    params_mu: 0.5
    params_part1_ans1_value: 120.0 $N$, up the incline
    params_part1_ans2_value: 170.0 $N$, up the incline
    params_part1_ans3_value: 59.0 $N$, down the incline
    params_part1_ans4_value: 84.0 $N$, down the incline
    params_part1_ans5_value: 120.0 $N$, down the incline
---
# {{ params_vars_title }}
