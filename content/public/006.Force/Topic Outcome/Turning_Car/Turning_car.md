  ...
  substitutions:
    params:
      ...
      part1:
        ...
        ans3:
          value: Your pickup truck is moving along a circular path, and a centripetal
            acceleration is required. Without a force to push it towards the middle,
            objects(your shoulders, the soup cans) will NOT move in a circle along
            with the rest of the pickup truck, and so will move relative to the pickup
            truck's interior.
        ans4:
          value: Turning to the right forces your pickup truck to tilt, and all the
            cans and the shoulders shift down-hill.
---
# {{ params.vars.title }}
