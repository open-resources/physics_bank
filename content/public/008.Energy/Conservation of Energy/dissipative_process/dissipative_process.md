...
myst:
  substitutions:
    ...
    params_part1_ans1_value: Coherent deformations are dissipative.
    ...
    params_part1_ans3_value: Dissipative processes are one where the total mechanical
      energy is not conserved.
    params_part1_ans4_value: Irreversible processes are dissipative.
    params_part1_ans5_value: Incoherent deformations are dissipative
---
# {{ params_vars_title }}
