...
myst:
  substitutions:
    ...
    params_part1_ans1_value: The total momentum vectors they use to describe the asteroid
      system (both pieces) will be the same.
    params_part1_ans2_value: The final speeds they measure for the two asteroid pieces
      will be the same.
    params_part1_ans3_value: They will both agree on how the total kinetic energy
    ...
    params_part1_ans5_value: The change in the momentum vector they determine for
