...
myst:
  substitutions:
    ...
    params_part1_ans1_value: The final velocity vectors they use to describe the two
    ...
    params_part1_ans4_value: They will both agree on how much kinetic energy each
      of the asteroid pieces has.
    params_part1_ans5_value: The force vector they determine that each piece of the
