...
myst:
  substitutions:
    ...
    params_part1_ans5_value: The total momentum vectors they use to describe the asteroid
      system (both pieces) will be the same.
    params_part1_ans6_value: They will both agree on how the kinetic energy of each
