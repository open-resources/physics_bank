...
myst:
  substitutions:
    ...
    params_part1_ans1_value: $\Delta v_{y 2 \to 3 } = \Delta v_{y 3 \to 6 } + 2 $
    params_part1_ans1_feedback: Hmm, not quite. Try relating the change in velocity
      to the time interval and compare those.
    params_part1_ans2_value: $\Delta v_{y 2 \to 3 }=0$ ; $\Delta v_{y 3 \to 6 }<0$
    ...
    params_part1_ans3_value: $\Delta v_{y 2 \to 3 } = 3\Delta v_{y 3 \to 6 }$
    params_part1_ans3_feedback: Close! Try double-checking your algebra.
    params_part1_ans4_value: $\Delta v_{ y 2 \to 3 } = \frac{ 1 }{ 3 }\Delta v_{y
      3 \to 6 }$
    params_part1_ans4_feedback: Great! You got it.
    params_part1_ans5_value: $\Delta v_{y 2 \to 3 } = \frac{ 1 }{ 6 }\Delta v_{y 3
      \to 6 }$
