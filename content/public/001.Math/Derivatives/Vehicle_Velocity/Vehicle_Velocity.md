...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (5$\hat{\imath}$ + 722/9$\hat{\jmath}$)
      ans2:
        value: (5$\hat{\imath}$ + 81$\hat{\jmath}$)
      ans3:
        value: (6$\hat{\imath}$ + 250/3$\hat{\jmath}$)
      ans4:
        value: (6$\hat{\imath}$ + 722/9$\hat{\jmath}$)
      ans5:
        value: (5$\hat{\imath}$ + 250/3$\hat{\jmath}$)
---
# {{ params.vars.title }}
