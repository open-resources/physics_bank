...
myst:
  substitutions:
    ...
    params_j_2: 1
    params_s: 1
    params_part1_ans1_value: (7$\hat{\imath}$ - 5$\hat{\jmath}$)
    params_part1_ans2_value: (7$\hat{\imath}$ + 3$\hat{\jmath}$)
    params_part1_ans3_value: (3$\hat{\imath}$ + 9$\hat{\jmath}$)
    params_part1_ans4_value: (3$\hat{\imath}$ - 5$\hat{\jmath}$)
    params_part1_ans5_value: (7$\hat{\imath}$ + 9$\hat{\jmath}$)
---
# {{ params_vars_title }}
