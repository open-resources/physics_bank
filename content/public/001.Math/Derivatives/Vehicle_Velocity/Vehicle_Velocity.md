...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (21$\hat{\imath}$ + 719/9$\hat{\jmath}$)
      ans2:
        value: (21$\hat{\imath}$ + 81$\hat{\jmath}$)
      ans3:
        value: (27$\hat{\imath}$ + 253/3$\hat{\jmath}$)
      ans4:
        value: (27$\hat{\imath}$ + 719/9$\hat{\jmath}$)
      ans5:
        value: (21$\hat{\imath}$ + 253/3$\hat{\jmath}$)
---
# {{ params.vars.title }}
