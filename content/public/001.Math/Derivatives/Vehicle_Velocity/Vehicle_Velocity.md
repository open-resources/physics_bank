...
myst:
  substitutions:
    ...
    params_j_2: 2
    params_s: 3
    params_part1_ans1_value: (21$\hat{\imath}$ + 478/9$\hat{\jmath}$)
    params_part1_ans2_value: (21$\hat{\imath}$ + 54$\hat{\jmath}$)
    params_part1_ans3_value: (27$\hat{\imath}$ + 170/3$\hat{\jmath}$)
    params_part1_ans4_value: (27$\hat{\imath}$ + 478/9$\hat{\jmath}$)
    params_part1_ans5_value: (21$\hat{\imath}$ + 170/3$\hat{\jmath}$)
---
# {{ params_vars_title }}
