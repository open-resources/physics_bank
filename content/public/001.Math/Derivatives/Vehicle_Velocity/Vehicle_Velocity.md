...
myst:
  substitutions:
    ...
    params_j_2: 1
    params_s: 3
    params_part1_ans1_value: (21$\hat{\imath}$ + 235/9$\hat{\jmath}$)
    params_part1_ans2_value: (21$\hat{\imath}$ + 27$\hat{\jmath}$)
    params_part1_ans3_value: (27$\hat{\imath}$ + 89/3$\hat{\jmath}$)
    params_part1_ans4_value: (27$\hat{\imath}$ + 235/9$\hat{\jmath}$)
    params_part1_ans5_value: (21$\hat{\imath}$ + 89/3$\hat{\jmath}$)
---
# {{ params_vars_title }}
