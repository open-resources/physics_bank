...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (5$\hat{\imath}$ + 87/4$\hat{\jmath}$)
      ans2:
        value: (5$\hat{\imath}$ + 24$\hat{\jmath}$)
      ans3:
        value: (2$\hat{\imath}$ + 41/2$\hat{\jmath}$)
      ans4:
        value: (2$\hat{\imath}$ + 87/4$\hat{\jmath}$)
      ans5:
        value: (5$\hat{\imath}$ + 41/2$\hat{\jmath}$)
---
# {{ params.vars.title }}
