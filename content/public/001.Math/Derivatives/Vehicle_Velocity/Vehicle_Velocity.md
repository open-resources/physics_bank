...
myst:
  substitutions:
    ...
    params_j_2: 2
    params_s: 3
    params_part1_ans1_value: (5$\hat{\imath}$ + 476/9$\hat{\jmath}$)
    params_part1_ans2_value: (5$\hat{\imath}$ + 54$\hat{\jmath}$)
    params_part1_ans3_value: (6$\hat{\imath}$ + 172/3$\hat{\jmath}$)
    params_part1_ans4_value: (6$\hat{\imath}$ + 476/9$\hat{\jmath}$)
    params_part1_ans5_value: (5$\hat{\imath}$ + 172/3$\hat{\jmath}$)
---
# {{ params_vars_title }}
