...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (17$\hat{\imath}$ + 478/9$\hat{\jmath}$)
      ans2:
        value: (17$\hat{\imath}$ + 54$\hat{\jmath}$)
      ans3:
        value: (24$\hat{\imath}$ + 170/3$\hat{\jmath}$)
      ans4:
        value: (24$\hat{\imath}$ + 478/9$\hat{\jmath}$)
      ans5:
        value: (17$\hat{\imath}$ + 170/3$\hat{\jmath}$)
---
# {{ params.vars.title }}
