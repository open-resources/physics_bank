...
myst:
  substitutions:
    ...
    params_j_2: 2
    params_s: 2
    params_part1_ans1_value: (5$\hat{\imath}$ + 43/2$\hat{\jmath}$)
    params_part1_ans2_value: (5$\hat{\imath}$ + 24$\hat{\jmath}$)
    params_part1_ans3_value: (2$\hat{\imath}$ + 21$\hat{\jmath}$)
    params_part1_ans4_value: (2$\hat{\imath}$ + 43/2$\hat{\jmath}$)
    params_part1_ans5_value: (5$\hat{\imath}$ + 21$\hat{\jmath}$)
---
# {{ params_vars_title }}
