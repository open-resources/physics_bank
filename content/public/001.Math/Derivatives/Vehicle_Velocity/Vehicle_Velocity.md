...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (13$\hat{\imath}$ + 39/4$\hat{\jmath}$)
      ans2:
        value: (13$\hat{\imath}$ + 12$\hat{\jmath}$)
      ans3:
        value: (10$\hat{\imath}$ + 25/2$\hat{\jmath}$)
      ans4:
        value: (10$\hat{\imath}$ + 39/4$\hat{\jmath}$)
      ans5:
        value: (13$\hat{\imath}$ + 25/2$\hat{\jmath}$)
---
# {{ params.vars.title }}
