...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (2$\hat{\imath}$ + 89/4$\hat{\jmath}$)
      ans2:
        value: (2$\hat{\imath}$ + 24$\hat{\jmath}$)
      ans3:
        value: (0$\hat{\imath}$ + 39/2$\hat{\jmath}$)
      ans4:
        value: (0$\hat{\imath}$ + 89/4$\hat{\jmath}$)
      ans5:
        value: (2$\hat{\imath}$ + 39/2$\hat{\jmath}$)
---
# {{ params.vars.title }}
