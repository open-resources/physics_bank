...
myst:
  substitutions:
    ...
    params_j_2: 1
    params_s: 2
    params_part1_ans1_value: (3$\hat{\imath}$ + 39/4$\hat{\jmath}$)
    params_part1_ans2_value: (3$\hat{\imath}$ + 12$\hat{\jmath}$)
    params_part1_ans3_value: (2$\hat{\imath}$ + 25/2$\hat{\jmath}$)
    params_part1_ans4_value: (2$\hat{\imath}$ + 39/4$\hat{\jmath}$)
    params_part1_ans5_value: (3$\hat{\imath}$ + 25/2$\hat{\jmath}$)
---
# {{ params_vars_title }}
