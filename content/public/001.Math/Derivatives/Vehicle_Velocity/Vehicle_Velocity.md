...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (16$\hat{\imath}$ + 236/9$\hat{\jmath}$)
      ans2:
        value: (16$\hat{\imath}$ + 27$\hat{\jmath}$)
      ans3:
        value: (21$\hat{\imath}$ + 88/3$\hat{\jmath}$)
      ans4:
        value: (21$\hat{\imath}$ + 236/9$\hat{\jmath}$)
      ans5:
        value: (16$\hat{\imath}$ + 88/3$\hat{\jmath}$)
---
# {{ params.vars.title }}
