...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (5$\hat{\imath}$ + 476/9$\hat{\jmath}$)
      ans2:
        value: (5$\hat{\imath}$ + 54$\hat{\jmath}$)
      ans3:
        value: (6$\hat{\imath}$ + 172/3$\hat{\jmath}$)
      ans4:
        value: (6$\hat{\imath}$ + 476/9$\hat{\jmath}$)
      ans5:
        value: (5$\hat{\imath}$ + 172/3$\hat{\jmath}$)
---
# {{ params.vars.title }}
