...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (22$\hat{\imath}$ + 235/9$\hat{\jmath}$)
      ans2:
        value: (22$\hat{\imath}$ + 27$\hat{\jmath}$)
      ans3:
        value: (30$\hat{\imath}$ + 89/3$\hat{\jmath}$)
      ans4:
        value: (30$\hat{\imath}$ + 235/9$\hat{\jmath}$)
      ans5:
        value: (22$\hat{\imath}$ + 89/3$\hat{\jmath}$)
---
# {{ params.vars.title }}
