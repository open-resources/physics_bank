...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (9$\hat{\imath}$ + 41/4$\hat{\jmath}$)
      ans2:
        value: (9$\hat{\imath}$ + 12$\hat{\jmath}$)
      ans3:
        value: (6$\hat{\imath}$ + 23/2$\hat{\jmath}$)
      ans4:
        value: (6$\hat{\imath}$ + 41/4$\hat{\jmath}$)
      ans5:
        value: (9$\hat{\imath}$ + 23/2$\hat{\jmath}$)
---
# {{ params.vars.title }}
