...
myst:
  substitutions:
    ...
    params_j_2: 2
    params_s: 1
    params_part1_ans1_value: (3$\hat{\imath}$ - 3$\hat{\jmath}$)
    params_part1_ans2_value: (3$\hat{\imath}$ + 6$\hat{\jmath}$)
    params_part1_ans3_value: (0$\hat{\imath}$ + 11$\hat{\jmath}$)
    params_part1_ans4_value: (0$\hat{\imath}$ - 3$\hat{\jmath}$)
    params_part1_ans5_value: (3$\hat{\imath}$ + 11$\hat{\jmath}$)
---
# {{ params_vars_title }}
