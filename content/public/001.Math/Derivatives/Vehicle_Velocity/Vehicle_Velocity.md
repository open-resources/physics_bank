...
myst:
  substitutions:
    ...
    params_j_2: 3
    params_s: 2
    params_part1_ans1_value: (15$\hat{\imath}$ + 137/4$\hat{\jmath}$)
    params_part1_ans2_value: (15$\hat{\imath}$ + 36$\hat{\jmath}$)
    params_part1_ans3_value: (14$\hat{\imath}$ + 55/2$\hat{\jmath}$)
    params_part1_ans4_value: (14$\hat{\imath}$ + 137/4$\hat{\jmath}$)
    params_part1_ans5_value: (15$\hat{\imath}$ + 55/2$\hat{\jmath}$)
---
# {{ params_vars_title }}
