...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (10$\hat{\imath}$ + 236/9$\hat{\jmath}$)
      ans2:
        value: (10$\hat{\imath}$ + 27$\hat{\jmath}$)
      ans3:
        value: (12$\hat{\imath}$ + 88/3$\hat{\jmath}$)
      ans4:
        value: (12$\hat{\imath}$ + 236/9$\hat{\jmath}$)
      ans5:
        value: (10$\hat{\imath}$ + 88/3$\hat{\jmath}$)
---
# {{ params.vars.title }}
