...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (2$\hat{\imath}$ + 135/4$\hat{\jmath}$)
      ans2:
        value: (2$\hat{\imath}$ + 36$\hat{\jmath}$)
      ans3:
        value: (0$\hat{\imath}$ + 57/2$\hat{\jmath}$)
      ans4:
        value: (0$\hat{\imath}$ + 135/4$\hat{\jmath}$)
      ans5:
        value: (2$\hat{\imath}$ + 57/2$\hat{\jmath}$)
---
# {{ params.vars.title }}
