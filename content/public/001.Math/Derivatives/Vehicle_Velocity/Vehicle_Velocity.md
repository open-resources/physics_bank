...
myst:
  substitutions:
    ...
    params_j_2: 3
    params_s: 1
    params_part1_ans1_value: (0$\hat{\imath}$ + 0$\hat{\jmath}$)
    params_part1_ans2_value: (0$\hat{\imath}$ + 9$\hat{\jmath}$)
    params_part1_ans3_value: (-1$\hat{\imath}$ + 12$\hat{\jmath}$)
    params_part1_ans4_value: (-1$\hat{\imath}$ + 0$\hat{\jmath}$)
    params_part1_ans5_value: (0$\hat{\imath}$ + 12$\hat{\jmath}$)
---
# {{ params_vars_title }}
