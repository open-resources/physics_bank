...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (9$\hat{\imath}$ + 137/4$\hat{\jmath}$)
      ans2:
        value: (9$\hat{\imath}$ + 36$\hat{\jmath}$)
      ans3:
        value: (6$\hat{\imath}$ + 55/2$\hat{\jmath}$)
      ans4:
        value: (6$\hat{\imath}$ + 137/4$\hat{\jmath}$)
      ans5:
        value: (9$\hat{\imath}$ + 55/2$\hat{\jmath}$)
---
# {{ params.vars.title }}
