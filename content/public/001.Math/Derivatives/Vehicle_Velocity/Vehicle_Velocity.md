...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (4$\hat{\imath}$ + 479/9$\hat{\jmath}$)
      ans2:
        value: (4$\hat{\imath}$ + 54$\hat{\jmath}$)
      ans3:
        value: (3$\hat{\imath}$ + 169/3$\hat{\jmath}$)
      ans4:
        value: (3$\hat{\imath}$ + 479/9$\hat{\jmath}$)
      ans5:
        value: (4$\hat{\imath}$ + 169/3$\hat{\jmath}$)
---
# {{ params.vars.title }}
