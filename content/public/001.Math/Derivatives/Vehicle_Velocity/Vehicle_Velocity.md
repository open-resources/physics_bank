...
myst:
  substitutions:
    ...
    params_j_2: 3
    params_s: 2
    params_part1_ans1_value: (14$\hat{\imath}$ + 34$\hat{\jmath}$)
    params_part1_ans2_value: (14$\hat{\imath}$ + 36$\hat{\jmath}$)
    params_part1_ans3_value: (12$\hat{\imath}$ + 28$\hat{\jmath}$)
    params_part1_ans4_value: (12$\hat{\imath}$ + 34$\hat{\jmath}$)
    params_part1_ans5_value: (14$\hat{\imath}$ + 28$\hat{\jmath}$)
---
# {{ params_vars_title }}
