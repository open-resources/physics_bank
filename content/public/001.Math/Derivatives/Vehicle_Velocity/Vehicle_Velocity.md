...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: (11$\hat{\imath}$ + 721/9$\hat{\jmath}$)
      ans2:
        value: (11$\hat{\imath}$ + 81$\hat{\jmath}$)
      ans3:
        value: (15$\hat{\imath}$ + 251/3$\hat{\jmath}$)
      ans4:
        value: (15$\hat{\imath}$ + 721/9$\hat{\jmath}$)
      ans5:
        value: (11$\hat{\imath}$ + 251/3$\hat{\jmath}$)
---
# {{ params.vars.title }}
