...
myst:
  substitutions:
    ...
    params_j_2: 2
    params_s: 3
    params_part1_ans1_value: (4$\hat{\imath}$ + 53$\hat{\jmath}$)
    params_part1_ans2_value: (4$\hat{\imath}$ + 54$\hat{\jmath}$)
    params_part1_ans3_value: (3$\hat{\imath}$ + 57$\hat{\jmath}$)
    params_part1_ans4_value: (3$\hat{\imath}$ + 53$\hat{\jmath}$)
    params_part1_ans5_value: (4$\hat{\imath}$ + 57$\hat{\jmath}$)
---
# {{ params_vars_title }}
