...
substitutions:
  params:
    ...
    part1:
      ...
      ans2:
        value: 1.7$\hat{\imath}$ + 0.26$\hat{\jmath}$
      ans3:
        value: 3.1$\hat{\imath}$ + 0.47$\hat{\jmath}$
      ans4:
        value: 1.7$\hat{\imath}$ + 0.27$\hat{\jmath}$
      ans5:
        value: -50.0$\hat{\imath}$ - 7.7$\hat{\jmath}$
      ans6:
        value: -12.0$\hat{\imath}$ - 1.9$\hat{\jmath}$
---
# {{ params.vars.title }}
## Part 1
