...
substitutions:
  params:
    ...
    part1:
      ans1:
        value: 8.5$\hat{\imath}$ - 20.0$\hat{\jmath}$
      ans2:
        value: 6.0$\hat{\imath}$ - 14.0$\hat{\jmath}$
      ans3:
        value: 21.0$\hat{\imath}$ - 49.0$\hat{\jmath}$
      ans4:
        value: 3.0$\hat{\imath}$ - 7.1$\hat{\jmath}$
      ans5:
        value: 5.4$\hat{\imath}$ - 23.0$\hat{\jmath}$
      ans6:
