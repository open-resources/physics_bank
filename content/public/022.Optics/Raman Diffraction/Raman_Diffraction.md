...
myst:
  substitutions:
    ...
    params_lambda1: 800
    params_lambda2: 350
    params_part1_ans1_value: The diffraction angle is larger for the $800$ $\rm{nm}$
      light.
    ...
    params_part1_ans2_value: The diffraction angle is smaller for the $800$ $\rm{nm}$
      light.
    ...
    params_part1_ans3_value: The diffraction angle is the same for both the $800$
