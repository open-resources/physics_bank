...
myst:
  substitutions:
    ...
    params_part1_ans9_value: Horizontal component of velocity at bottom of water,
      $v_{ix}$
    params_part2_ans1_value: $(3.5\; m/s^2, 12.6 \; m/s^2)$
    params_part2_ans2_value: $(12.6\; m/s^2, 3.5\; m/s^2)$
    params_part2_ans3_value: $(0 \; m/s^2, 13.1\; m/s^2)$
    params_part2_ans4_value: 9.81 $m/s^2$
    params_part2_ans5_value: $(4.0\; m/s^2, 8.04\; m/s^2)$
    params_part2_ans6_value: 8.04 $m/s^2$
---
# {{ params_vars_title }}
