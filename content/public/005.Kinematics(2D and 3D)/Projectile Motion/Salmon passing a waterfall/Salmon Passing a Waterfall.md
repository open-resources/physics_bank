...
myst:
  substitutions:
    ...
    params_part1_ans9_value: Horizontal component of velocity at bottom of water,
      $v_{ix}$
    params_part2_ans1_value: $(1.92\; m/s^2, 5.55 \; m/s^2)$
    params_part2_ans2_value: $(5.55\; m/s^2, 1.92\; m/s^2)$
    params_part2_ans3_value: $(0 \; m/s^2, 6.05\; m/s^2)$
    params_part2_ans4_value: 9.81 $m/s^2$
    params_part2_ans5_value: $(2.42\; m/s^2, 3.73\; m/s^2)$
    params_part2_ans6_value: 3.73 $m/s^2$
---
# {{ params_vars_title }}
