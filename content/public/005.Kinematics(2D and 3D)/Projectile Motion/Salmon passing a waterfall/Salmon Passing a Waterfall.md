...
myst:
  substitutions:
    ...
    params_part1_ans9_value: Horizontal component of velocity at bottom of water,
      $v_{ix}$
    params_part2_ans1_value: $(2.24\; m/s^2, 7.85 \; m/s^2)$
    params_part2_ans2_value: $(7.85\; m/s^2, 2.24\; m/s^2)$
    params_part2_ans3_value: $(0 \; m/s^2, 8.35\; m/s^2)$
    params_part2_ans4_value: 9.81 $m/s^2$
    params_part2_ans5_value: $(2.74\; m/s^2, 5.04\; m/s^2)$
    params_part2_ans6_value: 5.04 $m/s^2$
---
# {{ params_vars_title }}
