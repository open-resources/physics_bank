...
myst:
  substitutions:
    ...
    params_part1_ans9_value: Horizontal component of velocity at bottom of water,
      $v_{ix}$
    params_part2_ans1_value: $(1.45\; m/s^2, 11.8 \; m/s^2)$
    params_part2_ans2_value: $(11.8\; m/s^2, 1.45\; m/s^2)$
    params_part2_ans3_value: $(0 \; m/s^2, 12.3\; m/s^2)$
    params_part2_ans4_value: 9.81 $m/s^2$
    params_part2_ans5_value: $(1.95\; m/s^2, 6.63\; m/s^2)$
    params_part2_ans6_value: 6.63 $m/s^2$
---
# {{ params_vars_title }}
