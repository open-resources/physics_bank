...
myst:
  substitutions:
    ...
    params_part1_ans9_value: Horizontal component of velocity at bottom of water,
      $v_{ix}$
    params_part2_ans1_value: $(0.734\; m/s^2, 2.92 \; m/s^2)$
    params_part2_ans2_value: $(2.92\; m/s^2, 0.734\; m/s^2)$
    params_part2_ans3_value: $(0 \; m/s^2, 3.42\; m/s^2)$
    params_part2_ans4_value: 9.81 $m/s^2$
    params_part2_ans5_value: $(1.23\; m/s^2, 1.83\; m/s^2)$
    params_part2_ans6_value: 1.83 $m/s^2$
---
# {{ params_vars_title }}
