...
myst:
  substitutions:
    ...
    params_part1_ans9_value: Horizontal component of velocity at bottom of water,
      $v_{ix}$
    params_part2_ans1_value: $(2.22\; m/s^2, 9.66 \; m/s^2)$
    params_part2_ans2_value: $(9.66\; m/s^2, 2.22\; m/s^2)$
    params_part2_ans3_value: $(0 \; m/s^2, 10.2\; m/s^2)$
    params_part2_ans4_value: 9.81 $m/s^2$
    params_part2_ans5_value: $(2.72\; m/s^2, 5.94\; m/s^2)$
    params_part2_ans6_value: 5.94 $m/s^2$
---
# {{ params_vars_title }}
