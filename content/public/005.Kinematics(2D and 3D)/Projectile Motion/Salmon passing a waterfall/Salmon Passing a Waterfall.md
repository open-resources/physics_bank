...
myst:
  substitutions:
    ...
    params_part1_ans9_value: Horizontal component of velocity at bottom of water,
      $v_{ix}$
    params_part2_ans1_value: $(1.26\; m/s^2, 8.38 \; m/s^2)$
    params_part2_ans2_value: $(8.38\; m/s^2, 1.26\; m/s^2)$
    params_part2_ans3_value: $(0 \; m/s^2, 8.88\; m/s^2)$
    params_part2_ans4_value: 9.81 $m/s^2$
    params_part2_ans5_value: $(1.76\; m/s^2, 4.82\; m/s^2)$
    params_part2_ans6_value: 4.82 $m/s^2$
---
# {{ params_vars_title }}
