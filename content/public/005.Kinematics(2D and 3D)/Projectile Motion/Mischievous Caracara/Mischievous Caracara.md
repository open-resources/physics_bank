...
myst:
  substitutions:
    ...
    params_part4_ans3_value: North and down
    params_part4_ans3_feedback: Hmh...Try again!
    params_part4_ans4_value: South and down
    params_part4_ans4_feedback: Hmh...Try again!
    params_part4_ans5_value: West and up
    params_part4_ans5_feedback: Hmh...Try again!
    params_part4_ans6_value: East and down
    params_part4_ans6_feedback: The nut does not start moving down immediately
    params_part7_ans1_value: Down
    params_part7_ans1_feedback: Great! You got it.
    params_part7_ans2_value: North and up
    params_part7_ans2_feedback: Hmh...Try again!
    params_part7_ans3_value: South and up
    params_part7_ans3_feedback: Hmh...Try again!
    params_part7_ans4_value: East
    params_part7_ans4_feedback: Gravity is the only source of acceleration!
    params_part7_ans5_value: South and down
    params_part7_ans5_feedback: Hmh...Try again!
    params_part7_ans6_value: Up
    params_part7_ans6_feedback: 'Hint: acceleration due to gravity.'
---
# {{ params_vars_title }}
