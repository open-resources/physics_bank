...
myst:
  substitutions:
    ...
    params_part4_ans2_value: East and down
    params_part4_ans2_feedback: The nut does not start moving down immediately
    ...
    params_part4_ans5_value: East and up
    ...
    params_part7_ans6_value: West and down
