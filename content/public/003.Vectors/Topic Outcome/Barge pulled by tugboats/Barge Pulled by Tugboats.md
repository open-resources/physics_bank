...
myst:
  substitutions:
    ...
    params_theta_1: 44
    params_theta_2: 17
    params_part6_ans1_value: 11.1$^{\circ}$ to the left of AB.
    params_part6_ans2_value: 11.1$^{\circ}$ to the right of AB.
    params_part6_ans3_value: 78.9$^{\circ}$ to the left of AB.
    params_part6_ans4_value: 78.9$^{\circ}$ to the right of AB.
    params_part6_ans5_value: 111.0$^{\circ}$ to the left of AB.
    params_part6_ans6_value: 111.0$^{\circ}$ to the right of AB.
---
# {{ params_vars_title }}
