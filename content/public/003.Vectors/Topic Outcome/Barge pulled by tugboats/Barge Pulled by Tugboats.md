...
substitutions:
  params:
    ...
    part6:
      ans1:
        value: 7.86$^{\circ}$ to the right of AB.
      ans2:
        value: 7.86$^{\circ}$ to the left of AB.
      ans3:
        value: 82.1$^{\circ}$ to the right of AB.
      ans4:
        value: 82.1$^{\circ}$ to the left of AB.
      ans5:
        value: 78.6$^{\circ}$ to the right of AB.
      ans6:
        value: 78.6$^{\circ}$ to the left of AB.
---
# {{ params.vars.title }}
